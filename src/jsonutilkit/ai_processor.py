...
class AIJSONProcessor:
    ...
    @staticmethod
    def extract_json_from_text(text: str, multiple: bool = False) -> Union[Dict[str, Any], List[Dict[str, Any]], None]:
        """
    ...
    @staticmethod
    def parse_ai_response(response: str, expected_keys: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def batch_process_ai_responses(responses: List[str], 
                                 expected_keys: Optional[List[str]] = None) -> List[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def validate_ai_json_structure(data: Dict[str, Any], 
                                 required_structure: Dict[str, Any]) -> Tuple[bool, List[str]]:
        """
        ...
        def _validate_recursive(obj: Any, structure: Any, path: str = "") -> None:
            if isinstance(structure, dict):
                ...
                if not isinstance(obj, str):
                    errors.append(f"Expected string at {path}, got {type(obj).__name__}")
            
            elif structure == "number":
                if not isinstance(obj, (int, float)):
                    errors.append(f"Expected number at {path}, got {type(obj).__name__}")
            
            elif structure == "boolean":
                if not isinstance(obj, bool):
                    errors.append(f"Expected boolean at {path}, got {type(obj).__name__}")
